...
include './docs/javascript/chart_code.php';
...
chart.render();
  ...
  <title>AMS V 2.0.1 | Dashboard</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fa fa fa-desktop"></i>
              <p>
                Verification
                <i class="fas fa-angle-left right"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/tables/view_tasks.php" class="nav-link">
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <marquee direction="up" scrollamount="1" behavior="scroll" id="news-ticker">
                        <?php include 'get_updates_news.php'; ?>
                  </marquee>
                  </div>
                </div>
              </div>
