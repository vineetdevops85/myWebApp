<?php
// Include the common logout script
include("logout.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>AMS V2.0.1 | Add Topic</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <a href="#" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../forms/add_topic.php" class="nav-link active">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Alarms and Solutions</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="add_topic.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="tag" id="tag" class="form-control" placeholder="Enter alarm" autocomplete="off" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Solution</label>
                    <input type="text" name="details" id="details" class="form-control" placeholder="Enter Solution" autocomplete="off" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Alarm Image</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="image" id="image" accept="image/*" required>
                        <label class="custom-file-label" for="exampleInputFile">Attach Alarm screenshot</label>
                      </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $uploadDirectory = '../search/uploads/';
        ...
        // Execute the query
        $stmt->execute();
        echo '<p class="text-success">Great!!! Your Topic "' . $tag . '" inserted successfully!</p>';
...
?>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" value="Add Topic">Submit</button>
                </div>
              </form>
            </div>
          </div>
