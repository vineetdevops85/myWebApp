...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_query = "UPDATE your_table_name SET 
                     ...
                     site_id = '$siteid', 
                     date = '$date', 
                     scripting_type = '$script_type', 
                     description = '$description' 
                     WHERE market = '$market'";

    // Execute the query
    if (mysqli_query($your_db_connection, $update_query)) {
        echo "Update successful";
    } else {
        echo "Error updating record: " . mysqli_error($your_db_connection);
    }
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Alarm Management</span>
    </a>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter FA Location" name="fa" value="<?php echo isset($fa_value) ? $fa_value : ''; ?>" required> required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
