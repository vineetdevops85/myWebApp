...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
            include 'dbconfig.php'; // Include database connection script

            // Fetch entries with status "Pending" or "Rejected"
$sql = "SELECT * FROM entry WHERE status IN ('Pending', 'Rejected', 'Assigned')";
$result = mysqli_query($connection, $sql);
            ...
            echo "</td>";
                ...
                // Add dropdown to assign task
                echo "<td>";
                echo "<input type='hidden' name='task_ids[]' value='" . $row['id'] . "'>";
                echo "<select name='assign_to[]' style='width: 100%;'>";
                $employees_sql = "SELECT id, name FROM users WHERE role = 'employee'";
                $employees_result = mysqli_query($connection, $employees_sql);
                while ($employee_row = mysqli_fetch_assoc($employees_result)) {
                    $selected = ($employee_row['id'] == $row['assign_to']) ? 'selected' : '';
        ...
        <button type="submit" class="btn btn-success">Assign Verification</button>
    </form>
    </tbody>
</table>
