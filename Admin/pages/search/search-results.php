<?php
    ...
    // Process the search term from the form
    if (isset($_GET['searchTerm'])) {
        $searchTerm = $_GET['searchTerm'];

        // SQL query to search the "tag" column
        $sql = "SELECT * FROM topic WHERE tag LIKE '%$searchTerm%'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <h2 class="text-center display-4 text-info">Search</h2>
      </div>
    </section>
                ...
                <div class="col-md-8 offset-md-2">
                    <form action="search-results.php" method="GET">
                        <div class="input-group input-group-lg">
                            <input type="search" id="searchTerm" name="searchTerm" class="form-control form-control-lg" placeholder="Type your keywords here" required autocomplete="off">
                            <div class="input-group-append">
                                        ...
                                        <?php
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo '<h4 class="text-info">' . $row['tag'] . '</h4>';
                                                    echo '<img class="img-fluid" src="' . $row['image'] . '" alt="Photo" style="max-height: auto;">';
                                                    echo '<p class="mb-0">' . $row['details'] . '</p>';
                                                    echo '</div>';
                                                    echo '<hr>';
                                                }
                                            } else {
                                              echo '<img class="img-fluid" src="./uploads/no-result.png" alt="Photo" style="max-height: auto;">';
                                            }
